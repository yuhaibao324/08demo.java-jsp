...
public class SimpleMailSender {
    ...
    public static void main(String[] args) {
        ...
        mailInfo.setUserName("yuhaibao324@126.com");
        mailInfo.setPassword("mail123456");// 您的邮箱密码
        mailInfo.setFromAddress("yuhaibao324@126.com");
        String[] to = {"yuhaibao324@126.com"};
        mailInfo.setToAddress(to);
        String[] toCC = {"yuhaibao324@126.com"};
        mailInfo.setToCarbonCopyAddress(toCC);
        String[] toBCC = {"yuhaibao324@126.com"};
